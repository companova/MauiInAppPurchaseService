...
namespace Companova.Maui.InAppPurchase.Service
{
    ...
    public class InAppPurchaseService : IInAppPurchaseService
    {
        ...
        public async Task<IEnumerable<Product>> LoadProductsAsync(string[] productIds, ProductType productType)
        {
            ...
            // Create a Delegate which will receive product data.
        ...
        /// </summary>
        /// <param name="productType">Not used for iOS</param>
    ...
    internal class PaymentObserver : SKPaymentTransactionObserver
    {
        ...
        /// <summary>
        /// Task Source that is set to Complete when the Restore process is complete
        /// </summary>

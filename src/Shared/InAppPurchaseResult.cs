...
namespace Companova.Maui.InAppPurchase.Service
{
    ...
    public class InAppPurchaseResult
    {
        ...
        /// <summary>
        /// Indicates whether the purchase has been already acknowledged.
        /// </summary>
        public bool Acknowledged { get; set; }

        /// <summary>
        /// Indicates whether the subscription renews automatically. If true, the subscription is active, else false the user has canceled.
        /// </summary>

...
namespace Companova.Maui.InAppPurchase.Service
{
        ...
        IInAppPurchaseService
    {
        ...
        public void OnPurchasesUpdated(BillingResult result, IList<Purchase> listOfPurchases)
        {
            ...
            // We succeeded only when the ResponseCode is Ok.
            if (result.ResponseCode == BillingResponseCode.Ok)
            {
        ...
        /// <summary>
        /// Default Constructor for In-App-Purchase Service Implementation on Android
        /// </summary>
        ...
        // A dictionary of retrieved products (ProductDetails replaces SkuDetails in BillingClient 5+)
        ...
        /// <param name="productType">Product Type (either inapp or subs)</param>
        /// <returns></returns>
        public async Task<IEnumerable<Product>> LoadProductsAsync(string[] productIds, ProductType productType)
        {
            ...
            QueryProductDetailsResult queryResult = await _billingClient.QueryProductDetailsAsync(queryParams);
        ...
        public async Task<List<InAppPurchaseResult>> RestoreAsync(ProductType productType)
        {
            ...
            QueryPurchasesParams query = QueryPurchasesParams.NewBuilder().SetProductType(billingProductType).Build();
            ...
            // Convert to InAppPurchaseResult list and return
            ...
            {
                Log.Debug(_billingTag, $"ProductId: {p.Products.FirstOrDefault()}, Acknowledged: {p.IsAcknowledged}, State: {p.PurchaseState}");
        ...
        private string GetBillingProductType(ProductType productType)
        {
            switch (productType)
            {
        ...
        /// <summary>
        /// Finalizes the Purchase by calling AcknowledgePurchase or ConsumePurchase
        /// </summary>
        ...
        public async Task FinalizePurchaseAsync(string token, ProductType productType)
        {
            ...
            switch (productType)
            {
                ...
                case ProductType.NonConsumable:
                    await AcknowledgePurchaseAsync(token);
                    break;
                case ProductType.Consumable:
        ...
        private async Task AcknowledgePurchaseAsync(string token)
        {
            ...
            // Acknowledge the Non-Consumable or Subscription Product
